...
// Replace the entire function with a properly escaped version
// We'll construct the function line by line with proper escaping
const lines = [
...
console.log('Fixed all newlines in orchestrator-next-steps.js');
