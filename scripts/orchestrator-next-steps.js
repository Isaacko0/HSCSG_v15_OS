...
function initializeState() {
  const baseTasks = {
    ...
    "AREX_INTEGRATION": [
      {"id": "AREX-001", "title": "Importar top 100 AREX skills (ML ops)", "deps": [], "effort": 3, "value": 90, "workstream": "AREX_INTEGRATION", "source": "agent", "priority": 90, "blocks": ["AREX-002"], "status": "pending", "notes": "vLLM, SGLang, Unsloth, Diffusers, FAISS, AlphaFold2"},
      {"id": "AREX-002", "title": "Crear Unified Router HSCSG+AREX", "deps": ["AREX-001"], "effort": 5, "value": 95, "workstream": "AREX_INTEGRATION", "source": "agent", "priority": 95, "blocks": ["AREX-003", "AREX-004"], "status": "pending", "notes": "Progressive disclosure: HSCSG Native → AREX Imported → DisCo Creator"},
      {"id": "AREX-003", "title": "Integrar AREX Router en Orchestrator auto-execute", "deps": ["AREX-002"], "effort": 3, "value": 85, "workstream": "AREX_INTEGRATION", "source": "agent", "priority": 85, "blocks": ["AREX-005"], "status": "pending", "notes": "Router integration + skill registry merge"},
      {"id": "AREX-004", "title": "Auto-import pipeline para skills nuevos AREX", "deps": ["AREX-002"], "effort": 4, "value": 80, "workstream": "AREX_INTEGRATION", "source": "agent", "priority": 80, "blocks": [], "status": "pending", "notes": "Scheduled sync + license checker + PR automation"},
      {"id": "AREX-005", "title": "Skill Marketplace: publicar skills AREX importados", "deps": ["AREX-003"], "effort": 3, "value": 75, "workstream": "AREX_INTEGRATION", "source": "agent", "priority": 75, "blocks": [], "status": "pending", "notes": "Unified marketplace search/install/publish + bidirectional sync"}
    ],
    "LEGAL_PROTECTION": [
      {"id": "LP-001", "title": "Implementar legal_boundaries.ts con perfiles 11 repos", "deps": [], "effort": 2, "value": 95, "workstream": "LEGAL_PROTECTION", "source": "agent", "priority": 95, "blocks": ["LP-002", "LP-003", "LP-009"], "status": "pending", "notes": "LegalBoundary enum + RepoLegalProfile per repo"},
      {"id": "LP-002", "title": "Portar Loophole adversarial pattern a TS (4 agentes)", "deps": ["LP-001"], "effort": 5, "value": 90, "workstream": "LEGAL_PROTECTION", "source": "agent", "priority": 90, "blocks": ["LP-005", "LP-008", "LP-010"], "status": "pending", "notes": "Analyzer + Risk Finder + Gap Finder + Commercial Validator"},
      {"id": "LP-003", "title": "Implementar legal_template_engine.ts (Mike pattern)", "deps": ["LP-001"], "effort": 4, "value": 88, "workstream": "LEGAL_PROTECTION", "source": "agent", "priority": 88, "blocks": ["LP-004", "LP-006", "LP-007"], "status": "pending", "notes": "Markdown + YAML frontmatter + variables + conditionals + JSON Schema"},
      {"id": "LP-004", "title": "Crear plantillas base: ALA, RSA, DPA, CA", "deps": ["LP-003"], "effort": 3, "value": 92, "workstream": "LEGAL_PROTECTION", "source": "agent", "priority": 92, "blocks": ["LP-005"], "status": "pending", "notes": "Assimilation License Agreement, Revenue Share, DPA, Collaboration"},
      {"id": "LP-005", "title": "Integrar checkpoints legales en orchestrator (Fase 2/3/4)", "deps": ["LP-002", "LP-004"], "effort": 2, "value": 95, "workstream": "LEGAL_PROTECTION", "source": "agent", "priority": 95, "blocks": ["LP-010"], "status": "pending", "notes": "legal-audit-extract, legal-audit-adversarial, legal-audit-human-review"},
      {"id": "LP-006", "title": "LegalDashboard.tsx para revisión humana", "deps": ["LP-003"], "effort": 3, "value": 85, "workstream": "LEGAL_PROTECTION", "source": "agent", "priority": 85, "blocks": [], "status": "pending", "notes": "UI estilo Mike Playground para revisión legal asimilaciones"},
      {"id": "LP-007", "title": "CI/CD: Mike CLI en pipeline para generar acuerdos", "deps": ["LP-003"], "effort": 2, "value": 80, "workstream": "LEGAL_PROTECTION", "source": "agent", "priority": 80, "blocks": [], "status": "pending", "notes": "Build-time only enforcement, validate:agpl check"},
      {"id": "LP-008", "title": "Auditoría completa repos asimilados actuales (11)", "deps": ["LP-002"], "effort": 2, "value": 98, "workstream": "LEGAL_PROTECTION", "source": "agent", "priority": 98, "blocks": [], "status": "pending", "notes": "Ejecutar adversarial audit en 11 repos asimilados"},
      {"id": "LP-009", "title": "Documentar boundary AGPL (Mike) en skill hscsg-repo-assimilation", "deps": ["LP-001"], "effort": 1, "value": 70, "workstream": "LEGAL_PROTECTION", "source": "agent", "priority": 70, "blocks": [], "status": "pending", "notes": "Referencia en skill para futuras asimilaciones"},
      {"id": "LP-010", "title": "Crear skill hscsg-legal-audit (fusion Loophole + Mike)", "deps": ["LP-002", "LP-003", "LP-005"], "effort": 3, "value": 88, "workstream": "LEGAL_PROTECTION", "source": "agent", "priority": 88, "blocks": [], "status": "pending", "notes": "Skill unificada: adversarial agents + templates + compliance validator"}
    ]
  };
