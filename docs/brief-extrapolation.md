...
Priorizar Copiosis + Conway (desbloquean Autómata + GAIA_INTEGRATION). Crear skill copiosis-assimilation antes de empezar. Parallelizar backup/integration + specs.
