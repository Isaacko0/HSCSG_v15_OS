...
**Fuentes primarias:** 37 integraciones documentadas en `HSCSG_v15_OS/docs/` (incl. Copiosis v7.1, AuroraGov, Shivarthu, CompAI CRM, Didacta Community con backup + integración completa), informes ejecutivos HSCSG v14, análisis OneManCompany, IDETRA, repos asimilados.
